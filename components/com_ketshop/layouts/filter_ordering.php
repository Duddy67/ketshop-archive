...
?>
  ...
  <?php if($params->get('filter_ordering')) : ?>
	...
	<?php echo JText::_('COM_KETSHOP_SORTING_FILTER_LABEL').'&#160;'; ?>
      </label>
	...
	<option value="rorder" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_ORDERING_DESC'); ?></option>
	<?php $selected = ($filterOrdering === 'alpha') ? 'selected="selected"' : ''; ?>
	<option value="alpha" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_NAME_ASC'); ?></option>
	<?php $selected = ($filterOrdering === 'ralpha') ? 'selected="selected"' : ''; ?>
	<option value="ralpha" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_NAME_DESC'); ?></option>
	<?php if($optionDate) : ?>
	  <?php $selected = ($filterOrdering === 'date') ? 'selected="selected"' : ''; ?>
	  <option value="date" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_DATE_ASC'); ?></option>
	  <?php $selected = ($filterOrdering === 'rdate') ? 'selected="selected"' : ''; ?>
	  <option value="rdate" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_DATE_DESC'); ?></option>
	<?php endif; ?>
	<?php if($optionAuthor) : ?>
	  <?php $selected = ($filterOrdering === 'author') ? 'selected="selected"' : ''; ?>
	  <option value="author" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_AUTHOR_ASC'); ?></option>
	  <?php $selected = ($filterOrdering === 'rauthor') ? 'selected="selected"' : ''; ?>
	  <option value="rauthor" <?php echo $selected; ?>><?php echo JText::_('COM_KETSHOP_ORDERING_AUTHOR_DESC'); ?></option>
	<?php endif; ?>
