...
?>
  ...
  <?php else : ?>
	...
	<th>
	<?php echo JHtml::_('grid.sort', 'COM_KETSHOP_FIELD_NAME_LABEL', 'u.name', $listDirn, $listOrder); ?>
	</th>
	...
	<th width="10%">
	  <?php echo JText::_('COM_KETSHOP_HEADING_GROUPS'); ?>
	</th>
	<th class="nowrap" width="10%">
		<?php echo JHtml::_('grid.sort', 'COM_KETSHOP_HEADING_LAST_VISIT_DATE', 'u.lastvisitDate', $listDirn, $listOrder); ?>
	</th>
	<th class="nowrap" width="10%">
		<?php echo JHtml::_('grid.sort', 'COM_KETSHOP_HEADING_REGISTRATION_DATE', 'u.registerDate', $listDirn, $listOrder); ?>
	</th>
	<th class="nowrap" width="3%">
      ...
      $canChange = $user->authorise('core.edit.state','com_ketshop.customer.'.$item->id) && $canCheckin;
      ...
      <tr class="row<?php echo $i % 2; ?>">
	    ...
	    <?php if($canEdit || $canEditOwn) : ?>
	      <a href="<?php echo JRoute::_('index.php?option=com_ketshop&task=customer.edit&id='.$item->id);?>">
		...
		<?php echo $this->escape($item->email); ?>
		  ...
		  <?php if(count($item->groups) > 2) : ?>
		    <?php echo JText::_('COM_KETSHOP_USERS_MULTIPLE_GROUPS');?></p>
		  <?php else : ?>
		...
		<?php if ($item->lastvisitDate != '0000-00-00 00:00:00'):?>
			<?php echo JHtml::_('date', $item->lastvisitDate, JText::_('COM_KETSHOP_DATE_FORMAT')); ?>
		<?php else:?>
			<?php echo JText::_('JNEVER'); ?>
		<?php endif;?>
	      </td>
	      <td>
		<?php echo JHTML::_('date',$item->registerDate, JText::_('COM_KETSHOP_DATE_FORMAT')); ?>
	      </td>
	      <td class="center">
