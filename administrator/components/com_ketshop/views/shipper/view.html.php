...
class KetshopViewShipper extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_KETSHOP_NEW_SHIPPER') :
	JText::_('COM_KETSHOP_EDIT_SHIPPER'), 'shop-move-up');

    if($isNew) {
      //Check the "create" permission for the new records.
      if($canDo->get('core.create')) {
	JToolBarHelper::apply('shipper.apply', 'JTOOLBAR_APPLY');
	JToolBarHelper::save('shipper.save', 'JTOOLBAR_SAVE');
	JToolBarHelper::custom('shipper.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
      }
    }
    else {
	...
	if($canDo->get('core.edit') || ($canDo->get('core.edit.own') && $this->item->created_by == $userId)) {
      ...
      if($canDo->get('core.create')) {
	JToolBarHelper::save2copy('shipper.save2copy');
      }
    }

    JToolBarHelper::cancel('shipper.cancel', 'JTOOLBAR_CANCEL');
  }
