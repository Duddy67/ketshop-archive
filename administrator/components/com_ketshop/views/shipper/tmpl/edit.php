...
{
  if(task == 'shipper.cancel' || document.formvalidator.isValid(document.id('shipper-form'))) {
    Joomla.submitform(task, document.getElementById('shipper-form'));
  }
}
</script>


<form action="<?php echo JRoute::_('index.php?option=com_ketshop&view=shipper&layout=edit&id='.(int) $this->item->id); ?>" 
 method="post" name="adminForm" id="shipper-form" enctype="multipart/form-data" class="form-validate">
