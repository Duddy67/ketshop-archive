...
if($saveOrder) {
  $saveOrderingUrl = 'index.php?option=com_ketshop&task=paymentmodes.saveOrderAjax&tmpl=component';
...
?>
  ...
  <?php else : ?>
	...
	<th>
	<?php echo JHtml::_('searchtools.sort', 'COM_KETSHOP_HEADING_NAME', 'p.name', $listDirn, $listOrder); ?>
	</th>
	<th width="10%">
