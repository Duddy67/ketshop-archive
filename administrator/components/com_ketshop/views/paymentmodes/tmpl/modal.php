...
<form action="<?php echo JRoute::_('index.php?option=com_ketshop&view=paymentmodes&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
  ...
  <?php else : ?>
	...
	<tr>
	  <th class="title">
		  <?php echo JHtml::_('grid.sort', 'COM_KETSHOP_HEADING_NAME', 'p.name', $listDirn, $listOrder); ?>
	  </th>
	  <th width="15%">
