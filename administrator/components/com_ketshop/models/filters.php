...
class KetshopModelFilters extends JModelList
{
  ...
  protected function getListQuery()
  {
    ...
    $query->select($this->getState('list.select', 'f.id, f.name, f.created, f.published,'.
				   'f.created_by, f.checked_out, f.checked_out_time'));

    $query->from('#__ketshop_filter AS f');
